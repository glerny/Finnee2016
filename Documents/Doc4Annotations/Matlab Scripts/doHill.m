%% DESCRIPTION
% doHill check a chemical formula in input and re-order it to follow the 
% Hill system order
% (https://web.cas.org/training/stneasytips/subinforformula1.html). 
%
%% CURRENT DEVELOPMENT
% - 02/10/2020 -
% 
%% COPYRIGHT
% Copyright BSD 3-Clause License Copyright 2020 G. Erny
...
function [mf, a, Z] = doHill(mfString)
