function [Model, FittData, SSR] = getMSModels(ModelSpectra, Data, MZAxis, Options)
...
warning off
%% Find spectra to fit
Dms = mean(MZAxis(2:end, 1) - MZAxis(1:end-1, 1));
minVar   = (Dms*PtsPerPeaks/18)^2; %Peakwith at base (6 sigma) => PtsPerPeaks/3
idealVar = (Dms*PtsPerPeaks/6)^2; %Peakwith at base (6 sigma) => PtsPerPeaks
maxVar   = (Dms*3*PtsPerPeaks/6)^2; %Peakwith at base (6 sigma) => 3*PtsPerPeaks
