classdef Trace2 
    ...
    methods
        ...
        function obj = Trace2(structInfo, data2write)
            if nargin == 0
            else
        ...
        function data = get.Data(obj)
            fidReadDat = fopen(obj.Link2file, 'rb');
